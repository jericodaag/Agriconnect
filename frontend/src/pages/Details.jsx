    ...
    return (
        <div>
            ...
            <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                ...
                <Leaf className='text-green-600 w-7 h-7 stroke-[2.5]' />
                <h2 className='text-2xl font-bold text-gray-800'>Discover More</h2>
                </div>
                ...
                {relatedProducts.map((p, i) => (
                    ...
                    >
                        ...
                        <div className='py-3 px-2 bg-white rounded-b-lg'>
                        <h2 className='text-md font-semibold text-gray-700 truncate mb-1'>{p.name}</h2>
