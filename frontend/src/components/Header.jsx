...
const Header = () => {
    ...
    return (
        ...
        <div className='flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]'>
            <img src={`/images/${language.toLowerCase()}.png`} alt={language} className="w-6 h-4" />
            <span><IoMdArrowDropdown /></span>
            <ul className='absolute invisible transition-all top-12 rounded-sm duration-200 text-white p-2 w-[100px] flex flex-col gap-3 group-hover:visible group-hover:top-6 group-hover:bg-black z-10'>
            <li onClick={() => setLanguage('English')}>English</li>
            <li onClick={() => setLanguage('Filipino')}>Filipino</li>
            </ul>
        </div>
  ...
  <div onClick={() => navigate(userInfo ? '/dashboard/my-wishlist' : '/login') } className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-[#e2e2e2] hover:bg-[#059473] transition-colors duration-300'>
                            <span className='text-xl text-[#059473] hover:text-white transition-colors duration-300'><FaHeart /></span>

            {
                wishlist_count !== 0 && <div className='w-[20px] h-[20px] absolute bg-[#F98821] rounded-full text-white flex justify-center items-center -top-[3px] -right-[5px] '>
                {wishlist_count}
                </div>
            }                  
                        ...
                        <div onClick={redirect_card_page} className='relative flex justify-center items-center cursor-pointer w-[35px] h-[35px] rounded-full bg-[#e2e2e2] hover:bg-[#059473] transition-colors duration-300'>
                            <span className='text-xl text-[#059473] hover:text-white transition-colors duration-300'><FaCartShopping  /></span>
            
                {
                    card_product_count !== 0 && <div className='w-[20px] h-[20px] absolute bg-[#F98821] rounded-full text-white flex justify-center items-center -top-[3px] -right-[5px] '>
                        {
                            card_product_count
                        }
                     </div> 
    ...
    <div className='w-[85%] lg:w-[90%] mx-auto'>
        ...
        <div className='w-9/12 pl-8 md-lg:pl-0 md-lg:w-full'>
            <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                ...
                <div className='flex h-[50px] items-center relative gap-6 rounded-lg border border-[#059473] overflow-hidden'>
    <div className='relative after:absolute after:h-[25px] after:w-[1px] after:bg-[#afafaf] after:-right-[15px] md:hidden'>
        <select 
            onChange={(e) => setCategory(e.target.value)} 
            className='w-[150px] text-slate-600 text-sm font-semibold bg-transparent px-3 h-full outline-0 border-none'
            name="" 
            id=""
        >
    ...
    <input 
        className='w-full relative bg-transparent text-slate-500 text-sm outline-0 px-4 h-full' 
    ...
    <button 
        onClick={search} 
        className='bg-[#059473] right-0 absolute px-6 h-[80%] my-auto mr-1 text-sm font-semibold uppercase text-white hover:bg-[#04785d] transition-colors duration-300 rounded'
    >
        Search
    </button>
</div>
...
<div className='hidden md-lg:block'>
    ...
    <div className={`w-[300px] z-[9999] transition-all duration-200 fixed ${showShidebar ? '-left-[300px]' : 'left-0 top-0'} overflow-y-auto bg-white h-screen py-6 px-8`}>
        <div className='flex justify-start flex-col gap-6'>
            <Link to='/'>
                <img src="http://localhost:3000/images/logo.png" alt="Agriconnect" className="h-12" />
            </Link>
            <div className='flex justify-start items-center gap-10'>
                <div className='flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute'>
                    <img src={`/images/${language.toLowerCase()}.png`} alt={language} className="w-6 h-4" />
